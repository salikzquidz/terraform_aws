...
resource "aws_eks_fargate_profile" "kube-system" {
  ...
  fargate_profile_name = "kube-system" // I usually match it with kubernetes namespace
  ...
  selector {
    namespace = "kube-system" // specify ns for fargate to manage, other option can filter by pod labels
  }
}


# Patch pod level annotation by terraform script , make sure binaries needed are installed
